...
const UserPage = () => {
    ...
    return (
        <div className='w-full flex h-screen  '>
            <div className="flex flex-col space-y-3 w-1/4 p-6 bg-slate-600 h-screen text-start text-lg">
            ...
            <div className="w-full justify-center flex flex-col items-center  h-screen space-y-6">
                <p className='text-center text-3xl font-bold my-6'>Welcome to the User Panel</p>
                <Outlet></Outlet>
            </div>
        </div>
    );
